...
[![build](https://github.com/ChristofVerhoeven/elixlsx/actions/workflows/ci.yaml/badge.svg)](https://github.com/ChristofVerhoeven/elixlsx/actions/workflows/ci.yaml)
[![License](https://img.shields.io/hexpm/l/elixlsx.svg)](https://github.com/ChristofVerhoeven/elixlsx/blob/master/LICENSE)
[![Last Updated](https://img.shields.io/github/last-commit/ChristofVerhoeven/elixlsx.svg)](https://github.com/ChristofVerhoeven/elixlsx/commits/master)
...
As of version 0.7, elixlsx requires Elixir 1.19 or above. (github: ChristofVerhoeven/elixlsx)
...
```elixir
defp deps do
  [{:elixlsx, github: "ChristofVerhoeven/elixlsx"}]
end
```
...
See [example.exs](https://github.com/ChristofVerhoeven/elixlsx/blob/master/example.exs) for examples how to use the various features.
...
This library is MIT licensed. See the [LICENSE](https://github.com/ChristofVerhoeven/elixlsx/blob/master/LICENSE) for details.
